...
<!-- animate__fadeOutDown -->
    ...
    `}nextStepClicked(){console.log("nextStepClicked"),this.currentStepIndex=this.currentStepIndex+1,this.currentStep=this.config.steps[this.currentStepIndex],"QUESTIONNAIRE"===this.currentStep.type&&(this.currentQuestionIndex=0,this.currentQuestion=this.currentStep.questionList[this.currentQuestionIndex]);const e=this.shadowRoot.querySelector("#animate-container");e.classList.add("animate__fadeOutUp");const t=this;setTimeout(()=>{e.classList.remove("animate__fadeOutUp"),t.requestUpdate(),e.classList.add("animate__fadeInDown")},1e3)}previousClicked(){console.log("previousClicked"),this.currentStepIndex=this.currentStepIndex-1,this.currentStep=this.config.steps[this.currentStepIndex],this.requestUpdate()}_nextQuestion(e){if(console.log("_nextQuestion",e),this.currentQuestionIndex+1===this.currentStep.questionList.length)return this.currentQuestionIndex=0,void this.nextStepClicked();this.currentQuestionIndex=this.currentQuestionIndex+1,this.currentQuestion=this.currentStep.questionList[this.currentQuestionIndex];const t=this.shadowRoot.querySelector("#animate-container");t.classList.add("animate__fadeOutUp");const i=this;setTimeout(()=>{t.classList.remove("animate__fadeOutUp"),i.requestUpdate(),t.classList.add("animate__fadeInDown"),i.scrollTo({top:0,behavior:"smooth"})},1e3)}}window.customElements.define("singapore-incentives-match",K);export{K as SingaporeIncentivesMatch};
