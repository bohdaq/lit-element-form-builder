 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,i,n){const o=t[0];if("."===o){return new E(e,t.slice(1),i).parts}return"@"===o?[new $(e,t.slice(1),n.eventContext)]:"?"===o?[new P(e,t.slice(1),i)]:new k(e,t,i).parts}handleTextExpression(e){return new S(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
<!-- animate__fadeOutDown -->
    ...
    `}nextStepClicked(){console.log("nextStepClicked"),this.currentStepIndex=this.currentStepIndex+1,this.currentStep=this.config.steps[this.currentStepIndex],"QUESTIONNAIRE"===this.currentStep.type&&(this.currentQuestionIndex=0,this.currentQuestion=this.currentStep.questionList[this.currentQuestionIndex]);const e=this.shadowRoot.querySelector("#animate-container");e.classList.remove("animate__bounce"),e.classList.add("animate__fadeOutDown");const t=this;setTimeout(()=>{t.requestUpdate()},1e3)}previousClicked(){console.log("previousClicked"),this.currentStepIndex=this.currentStepIndex-1,this.currentStep=this.config.steps[this.currentStepIndex],this.requestUpdate()}_nextQuestion(e){if(console.log("_nextQuestion",e),this.currentQuestionIndex+1===this.currentStep.questionList.length)return this.currentQuestionIndex=0,void this.nextStepClicked();this.currentQuestionIndex=this.currentQuestionIndex+1,this.currentQuestion=this.currentStep.questionList[this.currentQuestionIndex],this.requestUpdate()}}window.customElements.define("singapore-incentives-match",K);export{K as SingaporeIncentivesMatch};
