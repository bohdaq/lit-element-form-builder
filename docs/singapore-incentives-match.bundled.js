 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,i,s){const o=t[0];if("."===o){return new C(e,t.slice(1),i).parts}return"@"===o?[new E(e,t.slice(1),s.eventContext)]:"?"===o?[new z(e,t.slice(1),i)]:new k(e,t,i).parts}handleTextExpression(e){return new $(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
