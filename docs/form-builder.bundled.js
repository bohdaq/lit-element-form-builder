 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,i,s){const o=e[0];if("."===o){return new O(t,e.slice(1),i).parts}return"@"===o?[new D(t,e.slice(1),s.eventContext)]:"?"===o?[new C(t,e.slice(1),i)]:new $(t,e,i).parts}handleTextExpression(t){return new _(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const I=(t,...e)=>new b(t,e,"html",B)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const Q={};class X extends H{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(void 0===t)this._styles=[];else if(Array.isArray(t)){const e=(t,i)=>t.reduceRight((t,i)=>Array.isArray(i)?e(i,t):(t.add(i),t),i),i=e(t,new Set),s=[];i.forEach(t=>s.unshift(t)),this._styles=s}else this._styles=[t]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?J?this.renderRoot.adoptedStyleSheets=t.map(t=>t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==Q&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return Q}}X.finalized=!0,X.render=(t,i,s)=>{if(!s||"object"!=typeof s||!s.scopeName)throw new Error("The `scopeName` option is required.");const o=s.scopeName,r=M.has(i),n=N&&11===i.nodeType&&!!i.host,h=n&&!L.has(o),a=h?document.createDocumentFragment():i;if(((t,i,s)=>{let o=M.get(i);void 0===o&&(e(i,i.firstChild),M.set(i,o=new _(Object.assign({templateFactory:T},s))),o.appendInto(i)),o.setValue(t),o.commit()})(t,a,Object.assign({templateFactory:U(o)},s)),h){const t=M.get(a);M.delete(a);const s=t.value instanceof w?t.value.template:void 0;z(o,a,s),e(i,i.firstChild),i.appendChild(a),M.set(i,t)}!r&&n&&window.ShadyCSS.styleElement(i.host)};window.customElements.define("draggable-entity",class extends X{static get styles(){return K`
    ...
    `}static get properties(){return{control:{type:String}}}constructor(){super()}render(){return I`
      <slot></slot>
    ...
    `}static get properties(){return{selected:{type:Boolean,converter:(t,e)=>"true"===t},isDraggedOver:{type:Boolean},isFromTopToBottom:{type:Boolean}}}constructor(){super(),this.isDraggedOver=!1,this.fromTopToBottom=!0}render(){return I`
    ...
    `}static get properties(){return{index:{type:Number},isDraggedOver:{type:Boolean}}}constructor(){super()}render(){return I`
